"""
Plugin execution telemetry for runtime observability.

Captures duration, exit code, output size, parser time,
timeout reason, and resource hints per plugin run.
"""
