...
def parse(output: str) -> Dict[str, Any]:
    ...
    security_headers = {
        "x-frame-options": (
            ...
            "The lack of X-Frame-Options makes the site vulnerable to clickjacking.",
        ),
        "x-content-type-options": (
            "Missing X-Content-Type-Options Header",
            "Without this header set to 'nosniff', the browser may try to MIME-sniff the content, potentially executing malicious code.",
        ),
        "content-security-policy": (
            "Missing Content-Security-Policy Header",
            "CSP helps mitigate XSS and other injection attacks. It is currently missing.",
        ),
        "strict-transport-security": (
            "Missing Strict-Transport-Security Header",
            "HSTS should be enabled to force HTTPS connections.",
        ),
    }
