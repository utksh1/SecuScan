...
def test_select_tests_backend_only():
    ...
    assert select_tests(["backend/secuscan/main.py", "testing/backend/unit/test_models.py"]) == (True, False)

def test_select_tests_frontend_only():
    assert select_tests(["frontend/src/App.tsx"]) == (False, True)
    assert select_tests(["frontend/src/App.tsx", "frontend/package.json"]) == (False, True)
...
def test_select_tests_mixed_backend_frontend():
    ...
    assert select_tests(["backend/secuscan/main.py", "frontend/src/App.tsx"]) == (True, True)

def test_select_tests_mixed_backend_plugins():
    # Backend + plugins should only run backend tests
    assert select_tests(["backend/secuscan/main.py", "plugins/nmap/metadata.json"]) == (True, False)
