...
def _seed_audit_data(event_type="scan_start", severity="info", message="test event",
                      plugin_id=None, task_id=None):
    return {
...
def test_get_audit_logs_with_data(test_client):
    import asyncio
...
def test_audit_pagination_bounds(test_client):
    import asyncio
    from backend.secuscan.database import get_db
...
def test_audit_filter_by_event_type(test_client):
    import asyncio
    from backend.secuscan.database import get_db
...
def test_audit_export_json(test_client):
    import asyncio
    from backend.secuscan.database import get_db
...
def test_audit_export_csv(test_client):
    import asyncio
    from backend.secuscan.database import get_db
...
def test_audit_log_preserved_on_task_deletion(test_client):
    import asyncio
    import json
