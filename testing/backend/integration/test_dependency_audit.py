...
class TestDependencyAudit:
    ...
    def test_check_pip_audit_passes_with_no_vulns(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = subprocess.run(
                [
                    sys.executable,
                    str(SCRIPTS_DIR / "check_pip_audit.py"),
                    "--report",
                    str(report_file),
                    "--config",
                    str(config_file),
            ...
            assert (
                "no vulnerabilities" in result.stderr.lower()
    ...
    def test_pip_exception_bypasses_block(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert result.returncode == 0
            assert (
                "exceptions applied" in result.stderr.lower()
                or "exceptions applied" in result.stdout.lower()
            )
    ...
    def test_check_npm_audit_passes_with_no_vulns(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = subprocess.run(
                [
                    sys.executable,
                    str(SCRIPTS_DIR / "check_npm_audit.py"),
                    "--report",
                    str(report_file),
                    "--config",
                    str(config_file),
            ...
            assert result.returncode == 0
            assert (
                "no npm vulnerabilities" in result.stderr.lower()
                or "passed" in result.stderr.lower()
            )
    ...
    def test_npm_exception_bypasses_block(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert result.returncode == 0
            assert (
                "excepted" in result.stderr.lower()
                or "excepted" in result.stdout.lower()
            )
