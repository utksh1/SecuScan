...
global.fetch = vi.fn().mockResolvedValue({
  json: () => Promise.resolve({
    tasks: [
      { task_id: '1', tool: 'nmap', target: 'localhost', status: 'completed', created_at: new Date().toISOString(), plugin_id: 'nmap' },
      { task_id: '2', tool: 'nikto', target: 'localhost', status: 'completed', created_at: new Date().toISOString(), plugin_id: 'nikto' },
    ],
