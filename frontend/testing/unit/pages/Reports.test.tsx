...
describe("Reports — error state", () => {
  ...
  it("shows error message when fetch fails", async () => {
    ...
    expect(
      await screen.findByText(/Archive_Retrieval_Failed/i),
    ).toBeInTheDocument();
...
describe("Reports — empty state", () => {
  ...
  it("shows Archive Isolated when filter returns no matching reports", async () => {
    ...
    await user.click(
      screen.getByRole("button", { name: /executive briefings/i }),
    );
...
describe("Reports — type filter", () => {
  ...
  it("shows all reports when All filter is selected", async () => {
    ...
    expect(
      screen.getByText(/Security Scan — staging.example.com/i),
    ).toBeInTheDocument();
  });
  ...
  it("shows only matching reports when a type filter is selected", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.queryByText(/Security Scan — example.com/i),
