                                                            ...
                                                            <div className="flex items-center justify-end gap-6">
                                                                {(task.status === 'completed' || task.status === 'failed' || task.status === 'cancelled') && (
                                                                    <button
                                                                        ...
                                                                        onClick={(e) => { e.stopPropagation(); handleTaskDelete(task.task_id) }}
                                                                    >
                                                                        Delete_Record
                                                                ...
                                                                {(task.status === 'completed' || task.status === 'failed') && (
                                                                    <button
                                                                        ...
                                                                        onClick={(e) => { e.stopPropagation(); handleRescan(task) }}
                                                                    >
                                                                        Rescan_Signal
                                                                ...
                                                                <button
                                                                    ...
                                                                    onClick={(e) => { e.stopPropagation(); navigate(routePath.task(task.task_id)) }}
                                                                >
                                                                    Open_Deep_Brief
