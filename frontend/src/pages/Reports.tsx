        ...
        <div className="flex items-center gap-6">
           <button
             onClick={() => navigate('/reports/compare')}
              className="bg-rag-blue border-4 border-black px-6 py-4 text-[10px] font-black uppercase tracking-widest text-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all"
            >
            Compare Reports
         </button>
