        ...
        <>
          ...
          <section className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className={`${m.color} border-4 border-slate-300 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between h-40 group hover:-translate-y-1 transition-transform`}
              >
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-black text-slate-800 font-mono leading-none tracking-tighter">
                    {m.val}
                  </span>
                  <span className="text-[10px] font-black text-slate-800/100 uppercase tracking-widest">
                    {m.unit}
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-12">
              ...
              <section className="bg-charcoal border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {['all', 'executive', 'technical', 'compliance'].map((t) => (
                      ...
                      >
                        {t} BRIEFINGS
                        {/* FIX: removed duplicate ReportIcon, keep only one */}
                        {selectedType === t && (
                          <ReportIcon icon={Radar02Icon} size={16} className="text-slate-800" />
                        )}
                      </button>
                    ))}
                  </div>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {(
                        ...
                        >
                          {label}
                          {selectedStatus === value && (
                            <ReportIcon icon={Radar02Icon} size={16} className="text-black" />
                          )}
                        </button>
                      ))}
                    </div>
                ...
                <div className="p-8 border-4 border-black border-dashed space-y-4 bg-charcoal-dark/50">
                  <div className="flex items-center gap-3">
                    {/* FIX: removed duplicate KnightShieldIcon */}
                  ...
                  <p className="text-[10px] text-silver/100 font-black uppercase tracking-widest leading-loose italic">
                    Dossiers are cryptographically hashed and recorded. Modifications are strictly
                    detectable by the Enclave audit daemon.
                  </p>
                </div>
              </section>
            </aside>
            ...
            <main className="xl:col-span-3 space-y-8">
              <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b-4 border-slate-300 pb-8">
                ...
                <span className="text-[10px] font-mono text-silver/80 uppercase font-black mb-2 animate-pulse">
              ...
              <footer className="pt-24 border-t-4 border-slate-300/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[9px] font-black uppercase tracking-[0.5em] italic opacity-20">
                ...
                <div className="flex gap-4">
                  {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                    <div key={i} className="w-2 h-2 bg-silver/80 rounded-full"></div>
                  ))}
                </div>
              </footer>
            </main>
