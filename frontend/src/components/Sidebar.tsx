...
const NavSection = ({
  ...
  <AnimatePresence>
    {isExpanded ? (
      ...
      >
        <span className="text-[9px] font-black tracking-[0.2em] text-muted uppercase whitespace-nowrap">
          {label}
        </span>
        ...
        <div className={`flex items-center gap-4 px-6`}>
          ...
          <AnimatePresence>
            {isExpanded && (
              ...
              >
                <span className="text-[16px] font-black tracking-tighter text-primary italic">
                  SECUSCAN
                </span>
                <span className="text-[8px] font-bold tracking-[0.3em] text-rag-red mt-1">
                  LOCAL WORKSPACE
                </span>
              </motion.div>
            )}
