...
export const ExecutiveStatsBar: React.FC<ExecutiveStatsBarProps> = ({
  ...
  const compliance = Number.isFinite(compliancePercent)
    ? compliancePercent
    : 100;
  ...
  return (
    <div className="w-full bg-[var(--bg-secondary)] border-y border-white/5 py-16 grid grid-cols-1 md:grid-cols-4 divide-x divide-white/5">
      ...
      <div className="px-6 first:pl-8">
        <span className="text-xs font-bold text-white/70 uppercase tracking-[0.3em] block mb-6">
          Status Profile
        </span>
      ...
      <div className="px-6">
        ...
        <div className="space-y-8">
          ...
          <span
            className={`text-xs font-bold uppercase tracking-[0.25em] block ${hasCritical ? "text-[var(--rag-red)]" : "text-[var(--rag-green)]"}`}
          >
      ...
      <div className="px-6">
        ...
        <div className="space-y-8">
          <span
            className="text-8xl font-normal text-white leading-[0.8]"
            style={{ fontFamily: "var(--font-display)" }}
          >
