...
export const scanTools: ScanTool[] = [
    ...
    { id: 'sniper', name: 'Sniper: Auto-Exploiter', purpose: 'Validate critical CVEs by automatic exploitation.', riskLevel: 'aggressive', presetCompatibility: 'none', requiresConsent: true, category: 'exploit', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'sqli_exploiter', name: 'SQLi Exploiter', purpose: 'Exploit SQL injection in web apps to extract data.', riskLevel: 'aggressive', presetCompatibility: 'none', requiresConsent: true, category: 'exploit', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'xss_exploiter', name: 'XSS Exploiter', purpose: 'Exploit XSS in real life-attacks, extract cookies and data.', riskLevel: 'aggressive', presetCompatibility: 'none', requiresConsent: true, category: 'exploit', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'http_request_logger', name: 'HTTP Request Logger', purpose: 'Handle incoming HTTP requests and record data.', riskLevel: 'passive', presetCompatibility: 'none', requiresConsent: true, category: 'exploit', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'subdomain_takeover', name: 'Subdomain Takeover', purpose: 'Discover dangling DNS entries pointing to external services.', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: false, category: 'exploit', disabled: true, disabledReason: 'Module integration pending' },
    ...
    { id: 'waf_detector', name: 'WAF Detector', purpose: 'Automatically identify Web Application Firewalls protecting targets', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: false, category: 'robots', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'sitemap_gen', name: 'Sitemap Generator', purpose: 'Build complete XML sitemaps by autonomously parsing targets', riskLevel: 'passive', presetCompatibility: 'none', requiresConsent: false, category: 'robots', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'fuzzer', name: 'Payload Fuzzer', purpose: 'Autonomously fuzz target fields with massive dictionaries', riskLevel: 'aggressive', presetCompatibility: 'none', requiresConsent: true, category: 'robots', disabled: true, disabledReason: 'Module integration pending' },

    // --- PENDING / FUTURE ---
    { id: 'cloud_scanner', name: 'Cloud Scanner', purpose: 'Cloud infrastructure security (AWS/GCP/Azure)', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: true, category: 'vulnerability', subcategory: 'network', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'kubernetes_scanner', name: 'K8s Scanner', purpose: 'Kubernetes cluster security assessment', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: true, category: 'vulnerability', subcategory: 'network', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'api_scanner', name: 'API Scanner', purpose: 'Check for specific API vulnerabilities (REST and GraphQL)', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: true, category: 'vulnerability', subcategory: 'web', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'sharepoint_scanner', name: 'Sharepoint Scanner', purpose: 'Check SharePoint for security issues, misconfigs, and more', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: true, category: 'vulnerability', subcategory: 'web', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'network_scanner', name: 'Network Scanner', purpose: 'Check for 10,000+ CVEs and server misconfigurations', riskLevel: 'active', presetCompatibility: 'deep-scan', requiresConsent: true, category: 'vulnerability', subcategory: 'network', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'password_auditor', name: 'Password Auditor', purpose: 'Discover weak credentials in network services and web apps', riskLevel: 'active', presetCompatibility: 'none', requiresConsent: true, category: 'vulnerability', subcategory: 'network', disabled: true, disabledReason: 'Module integration pending' },
    
    // --- ADVANCED PROSPECTIVE SCANNERS ---
    { id: 'zap_scanner', name: 'DAST Web Proxy (ZAP)', purpose: 'Dynamic proxy spidering and payload injection', riskLevel: 'aggressive', presetCompatibility: 'deep-scan', requiresConsent: true, category: 'vulnerability', subcategory: 'web', disabled: true, disabledReason: 'Module integration pending' },
    ...
    { id: 'cloud_storage_auditor', name: 'S3 / Blob Auditor', purpose: 'Find misconfigured S3 buckets and exposed cloud storage', riskLevel: 'passive', presetCompatibility: 'none', requiresConsent: true, category: 'vulnerability', subcategory: 'network', disabled: true, disabledReason: 'Module integration pending' },
    { id: 'iac_scanner', name: 'IaC Scanner (Checkov)', purpose: 'Analyze Terraform and CloudFormation code for flaws', riskLevel: 'passive', presetCompatibility: 'none', requiresConsent: false, category: 'vulnerability', subcategory: 'code', disabled: true, disabledReason: 'Module integration pending' },
]
